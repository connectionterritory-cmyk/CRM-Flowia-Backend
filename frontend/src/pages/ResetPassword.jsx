        ...
        return (
            <div className="min-h-dvh bg-slate-50 flex items-center justify-center px-6">
                <div className="w-full max-w-md card-premium p-8 text-center">
                    ...
                    <h2 className="text-xl font-black text-slate-800">Enlace Inválido</h2>
                    <p className="text-sm text-slate-500 mt-2">No se encontró un token válido para restablecer la contraseña.</p>
        ...
        <div className="min-h-dvh bg-slate-50 flex items-center justify-center px-6">
            <div className="w-full max-w-md card-premium p-8">
                <div className="mb-8 text-center">
                    ...
                    <h1 className="text-2xl font-black text-slate-800 tracking-tighter mt-2">Nueva Contraseña</h1>
                    <p className="text-sm text-slate-500 mt-2">Ingresa tu nueva contraseña segura</p>
                </div>
